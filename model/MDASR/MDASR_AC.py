...
class CDM(nn.Module):
    def __init__(self, in_channels):
        ...
        self.SAM1 = SAM()
        self.c1_r=B.ACBlock(in_channels,self.rc)
        self.SAM1_= SAM()

        self.c2_d = B.conv_layer(self.rc, self.dc, 1)
        self.SAM2 = SAM()
        self.c2_r = B.ACBlock(self.rc, self.rc )
        self.SAM2_= SAM()

        self.c3_d = B.conv_layer(self.rc, self.dc, 1)
        self.SAM3 = SAM()
        self.c3_r = B.ACBlock(self.rc, self.rc)
        self.SAM3_=SAM()
...
class MDASR(nn.Module):
    def __init__(self, in_channels=3 ,out_channels=48,num_modules=6,scale=2):
